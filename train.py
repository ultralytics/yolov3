...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, help='where the checkpoints, results are stored')
    parser.add_argument('--data_dir', type=str, default='/data', help='where the data is stored')
    parser.add_argument('--pretrained_weights', type=str, default='', help='path to weights')
