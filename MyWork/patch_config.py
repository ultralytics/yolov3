...
class loss1(object):
    ...
    def __init__(self):
        ...
        self.img_dir = '/home/andread98/yolov3/MyWork/dataset'    # train images location
        self.lab_dir = '/home/andread98/yolov3/MyWork/dataset/yolo-labels'  # train labels location
        self.batch_size = 6
        self.n_epochs = 20
        self.max_lab = 30
        ...
        # Patch functions
        # self.list_function_tile = [Tile_Creator_Circle, Tile_Creator_Ellipse, Tile_Creator_Square, Tile_Creator_Rectangle, Tile_Creator_Triangle, Tile_Creator_Trapezoid]
        self.list_function_tile = [Tile_Creator_Double_Circle, Tile_Creator_Double_Ellipse, Tile_Creator_Double_Square, Tile_Creator_Double_Rectangle, Tile_Creator_Double_Triangle, Tile_Creator_Double_Trapezoid]
...
class loss2(loss1):
    ...
    def __init__(self):
        ...
        self.patch_name = 'max_prob_class2'
...
class loss4(loss1):
    ...
    def __init__(self):
        ...
        self.patch_name = 'new_loss_tprob'
