...
# Test
python3 test.py --img-size 416 --weights weights/latest.pt

# Test Darknet
python3 test.py --img-size 416 --weights ../darknet/backup/yolov3.backup
...
python3 test.py --img-size 416 --weights weights/backup5.pt --nms 0.45

# Download and Resume
sudo rm -rf yolov3 && git clone https://github.com/ultralytics/yolov3 && cd yolov3
wget https://storage.googleapis.com/ultralytics/yolov3.pt -O weights/latest.pt
python3 train.py --img-size 416 --batch 16 --epochs 1 --resume
python3 test.py --img-size 416 --weights weights/latest.pt --thr 0.5
