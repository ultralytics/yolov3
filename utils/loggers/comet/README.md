...
This guide explains how to use the [Comet](https://www.comet.com/docs/v2/) experiment tracking integration in YOLOv3.

## ℹ️ About Comet

[Comet](https://www.comet.com/docs/v2/) is an experiment tracking platform for machine learning and deep learning. With this integration a YOLOv3 run can:
...
export COMET_LOG_BATCH_METRICS=true                         # Log batch-level metrics. Defaults to false.
...
Comet provides rich visualizations for sweep results in the project view.
