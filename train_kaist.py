...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/kaist/kaist_person_day_ir.data', help='*.data path')
    ...
    parser.add_argument('--adam', default='store_true', action='store_true', help='use adam optimizer')
