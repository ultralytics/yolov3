...
"""
Export a YOLOv3 PyTorch model to TorchScript, ONNX, CoreML, TensorFlow (saved_model, pb, TFLite, TF.js,) formats
...
TensorFlow.js:
    ...
    $ npm install
    $ ln -s ../../yolov3/yolov3_web_model public/yolov3_web_model
    $ npm start
"""
...
def export_saved_model(model, im, file, dynamic,
    ...
    # YOLOv3 TensorFlow saved_model export
    keras_model = None
    try:
