...
def yolov5m(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    """
    Loads YOLOv5m model with options for pretrained weights, channel/class customization, autoshaping, and device
    selection.
    ...
    Args:
        ...
        classes (int, optional): Number of classes for the model. Default is 80.
        autoshape (bool, optional): If True, applies the YOLOv3 .autoshape() wrapper to the model for convenient input
            handling. Default is True.
        _verbose (bool, optional): If True, prints all information to the screen. Default is True.
        device (str | torch.device | None, optional): Device to use for model parameters. Default is None, which
            automatically selects the available device.

    Returns:
        torch.nn.Module: YOLOv5m model instance.

    Example:
        ```python
        import torch
        model = yolov5m(pretrained=True, channels=3, classes=80, autoshape=True, device='cuda:0')
        ```
    """
...
def yolov5l(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Args:
        ...
        channels (int, optional): Specifies the number of input channels. Default is 3.
        classes (int, optional): Defines the number of model classes. Default is 80.
        autoshape (bool, optional): If True, applies YOLOv5's .autoshape() wrapper to the model. Default is True.
        _verbose (bool, optional): If True, prints detailed information during model loading. Default is True.
        device (str | torch.device | None, optional): Device to use for model parameters ('cpu', 'cuda', etc.). If None,
            automatically selects the best available option. Default is None.

    Returns:
        (torch.nn.Module): The initialized YOLOv5l model with the specified options.
...
def yolov5x(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Args:
        ...
        autoshape (bool, optional): If True, applies the YOLOv5 .autoshape() wrapper, enabling handling of various input formats
            (file/URI/PIL/cv2/np) and non-maximum suppression (NMS). Defaults to True.
        _verbose (bool, optional): Whether to print detailed information during model loading. Defaults to True.
        device (str | torch.device | None, optional): Device to use for model computations (e.g., 'cpu', 'cuda'). If None, the
            best available device is automatically selected. Defaults to None.

    Returns:
        (torch.nn.Module): The instantiated YOLOv5x model.
    ...
    Refer to the [PyTorch Hub models](https://pytorch.org/hub/ultralytics_yolov5) for more details.
    ```
    """
...
def yolov5n6(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    """
    Loads the YOLOv5n6 model with options for pretrained weights, input channels, number of classes, autoshaping,
    verbosity, and device assignment.

    Args:
        pretrained (bool, optional): If True, loads pretrained weights into the model. Default is True.
        channels (int, optional): Number of input channels. Default is 3.
        classes (int, optional): Number of model classes. Default is 80.
        autoshape (bool, optional): If True, applies the YOLOv5 .autoshape() wrapper to allow handling of multiple input types
            (file/URI/PIL/cv2/np) and non-maximum suppression (NMS). Default is True.
        _verbose (bool, optional): If True, prints detailed information to the screen. Default is True.
        device (str | torch.device | None, optional): Device to use for model parameters (e.g., 'cpu', 'cuda'). If None, the best
            available device is automatically selected. Default is None.
    ...
    Example:
        ...
        model = torch.hub.load('ultralytics/yolov5:master', 'yolov5n6')
        model = torch.hub.load('ultralytics/yolov5', 'custom', 'yolov5n6.pt')
        model = torch.hub.load('.', 'custom', 'yolov5n6.pt', source='local')
        ```
    """
...
def yolov5m6(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    """
    Load the YOLOv5m6 model with options for pretrained weights, input channels, number of classes, autoshaping, and
    device selection.
...
def yolov5x6(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    """
    Loads the YOLOv5x6 model, allowing customization for pretrained weights, input channels, model classes, and device
    selection.
