...
def yolov5s(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    """
    ```python Loads the YOLOv5s model with customizable options for pretrained weights, input channels, number of
    classes, autoshape functionality, and device selection.
...
def yolov5l(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Args:
        ...
        channels (int, optional): Specifies the number of input channels. Default is 3.
        classes (int, optional): Defines the number of model classes. Default is 80.
        autoshape (bool, optional): Applies the YOLOv5 .autoshape() wrapper to the model for enhanced usability. Default is True.
        _verbose (bool, optional): If True, prints detailed information during model loading. Default is True.
        device (str | torch.device | None, optional): Specifies the device to load the model on. Accepts 'cpu', 'cuda', or torch.device. Default is None, which automatically selects the best available option.
...
def yolov5x6(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Args:
        ...
        device (str | torch.device | None): Specifies the device to load the model on ('cpu', 'cuda', etc.).
            Default is None, which uses the best available device.
