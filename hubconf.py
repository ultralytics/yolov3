...
def yolov5n(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    """
    Instantiates a YOLOv5n model with optional pretrained weights, configurable input channels, number of classes, autoshaping,
...
def yolov5m(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    """
    Loads the YOLOv5m model with options for pretrained weights, input channels, number of classes, autoshape functionality,
    and device selection.
...
def yolov5x(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    """
    Load the YOLOv5x model with options for pretrained weights, number of input channels, classes, autoshaping, and device 
    selection.
