...
def save_one_json(predn, jdict, path, class_map):
    ...
    Notes:
        ...
        - Each detection is converted to COCO-style format in the resulting JSON.
        - The `image_id` is derived from the stem of the provided `path`.
        - The function writes detections to the `jdict` list, which can be later saved as a JSON file.
    """
